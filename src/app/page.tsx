            ...
            <section id="welcome" className="md:flex w-full gap-5 px-10 md:px-32 py-32 relative">
                ...
                <div className="w-full flex items-center text-center md:text-left">
                    <div className="mb-10 md:mb-0">
                        ...
                        <p className="text-[3vw] md:text-[2vw] xl:text-[1vw] mt-10">Sustainably grown, fresh cut flowers for you our your special event or business. Proudly grown in Southern New Jersey, bouquets available at local Farmers Markets.</p>
