...
const Navbar = (props: Props) => {
    ...
    return (
        <div className="navbar bg-base-100 h-[2rem]">
            ...
            <div className="navbar-end">
                <Link href="https://www.facebook.com/profile.php?id=100064895851868" target="_blank" className="h-full mr-3">
                    <svg fill="#000000" width="25px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
		...
		c-2.762,0-5,2.238-5,5v50.844C76.703,162.867,78.941,165.106,81.703,165.106z" className="fill-base-content"/>
                        </g>
                    </svg>
                </Link>
            </div>
